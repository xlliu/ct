        ...
        try:
            for result in cursor.fetchall():
                ...
                cursorrd.execute(
                    ...
                    'firstfollowlooktime,firstfollowhouseid,data) values('
                    '%s,%s,%s,%s,%s,'
                    '%s,%s,%s,%s,%s,'
                    '%s,%s,%s,%s,%s,'
                    '%s,%s,%s)'
